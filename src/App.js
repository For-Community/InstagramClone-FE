...
const Routing =
    () => {
      ...
      return (<Switch><Route exact path = '/'><Home /><
              /Route>
...
App() {
  ...
  return (<UserContext.Provider value = {{ state, dispatch }}><BrowserRouter>
          <Navbar /><Routing /></BrowserRouter>
